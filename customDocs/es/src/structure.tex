...
\node[anchor=north] at (4cm,-2cm){\color{BlueViolet!40}\fontsize{220}{100}\sffamily\bfseries \rotatebox{90}{P\kern-2pt a\kern-6pt r\kern6pt t\kern-3pt e \thepart}}; 
...
\titleformat{\chapter}[hang]{\thispagestyle{empty}\flushright\sffamily\fontsize{50}{60}\selectfont\bfseries}{\textcolor{BlueViolet}{Capítulo \thechapter}}{0pt}{\flushleft\Huge\bfseries\sffamily\vspace{0.5em}\hrule\vspace{0.5em}}
...
\tikzstyle{arrow}=[->,-{Stealth[right,length=12pt,width=6pt]},thick]s